...
const Services = ({isMobile}: IPropsServices) => {
    ...
    return(
        <div className={styles.mainServicesContainer}>
            ...
            <img alt="pincel" src='/assets/icons/brush-icon.png' className={`${styles.animatedIcon} ${styles.brush}`} style={{top: '160px', left: '5%'}}/>
            <img alt="estrella" src='/assets/icons/star-icon.png' className={`${styles.animatedIcon} ${styles.star}`} style={{bottom: '40px', right: '3%'}}/>
        </div>
    )
}
